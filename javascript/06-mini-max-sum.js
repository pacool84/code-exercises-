 ...
 *
 * Print:
 * - Two space-separated integers on one line:
 *   1) the minimum sum
 *   2) the maximum sum
 *
 * Notes:
 * - No value should be returned.
 * - In some languages, a 64-bit integer is required because the sums can be large.
 *
 * Input Format:
 ...
 *
 * Imprime:
 * - Dos enteros separados por espacio en una sola linea:
 *   1) la suma minima
 *   2) la suma maxima
 *
 * Notas:
 * - No se debe retornar ningun valor.
 * - En algunos lenguajes se requiere un entero de 64 bits porque las sumas
 *   pueden ser grandes.
 *
 * Formato de entrada:
