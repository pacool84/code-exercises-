# Apple and Orange - Guia de estudio (Java)
...
### Listas en Java
- Trabajar con arreglos o listas de enteros.
- Recorrer todos los elementos de manzanas y naranjas.
...
2. Recorre el arreglo o lista de manzanas.
...
- Tiempo: `O(m + n)` porque recorres una vez las manzanas y una vez las naranjas.
...
- Repetir el ejercicio usando `for` clasico y luego `for-each`.
- Probar casos como:
